...
const NavBar = () => {
  ...
  return (
    <nav className={cn("absolute w-full z-4 transition-all duration-300",
        ...
        <div className="container flex items-center justify-between">
            <a className='text-xl font-bold text-primary flex items-center' href="#hero">
                <span className='relative z-10'>
                    <span className='text-glow text-foreground'>Sineth </span>Hansaja
                </span>
            </a>
            ...
            className='md:hidden p-2 text-foreground z-50'> {isMenuOpen ? <X size={24}/> : <Menu size={24}/>}</button>
            <div className={cn(
